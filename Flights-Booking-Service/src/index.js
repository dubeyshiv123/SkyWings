...
const { ServerConfig, Queue } = require("./config"); // If u are requiring from index.js file u don't need to specifically mention the file name i.e. index.js, it will automatically pick the index.js file
...
app.listen(ServerConfig.PORT, async () => {
  ...
  CRON(); // Calling the function to run the CRON JOBS
  await Queue.connectQueue();
  console.log("The queue is connected successfully");
});
