...
Email/Notification Service is down -> We are in maintenance
but people are still booking. Despite our email service being down once
it is up we have to send all those pending queued mails. 
*/
